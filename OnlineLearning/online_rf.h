...
class OnlineRF: public Classifier {
 public:
    ...
    void _updateTreeByOOBE(DataSet& vDataSet);
    void _updateTreeRandomly(const int vNumclass, const int vNumFeatures, const VectorXd& vMinFeatRange, const VectorXd& vMaxFeatRange);
    int _genRandomIntegerWithinRange(const int vMinRangeValue, const int vMaxRangeValue);
